export default {
  ...
  about: {
    ...
    update: {
      ...
      downloadProgressBytes: 'Downloading {percent}% ({done} / {total})',
      openStore: 'Open Store Update',
      openingStore: 'Opening update entry',
      installerOpening: 'APK downloaded. Opening installer',
      installPermissionRequired: 'Allow RPBox to install unknown apps, then return and tap update again',
      androidInAppHint: 'Android downloads the APK inside RPBox and opens the system installer when ready.',
      iosStoreHint: 'iOS does not allow apps to install updates themselves. Please update via App Store or TestFlight.',
      externalHint: 'This environment opens the system update entry.',
      redirecting: 'Opening update entry',
