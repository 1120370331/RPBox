export default {
  ...
  copyImportCode: 'Copy Code',
  shareItem: 'Share',
  shareItemOptionsTitle: 'Choose Share Type',
  shareItemAsLink: 'Share Link',
  shareItemAsFile: 'Share File',
  shareItemCancel: 'Cancel',
  importCodeUnavailable: 'This item does not have import code',
  copyImportCodeSuccess: 'Import code copied to clipboard',
  copyImportCodeFailed: 'Failed to copy, please try again',
