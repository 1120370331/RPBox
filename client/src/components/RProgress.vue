...
.r-progress__track { flex: 1; background: var(--btn-secondary-bg); border-radius: 4px; overflow: hidden; }
...
.r-progress--success { background: var(--color-success); }
.r-progress--warning { background: var(--color-warning-dark); }
.r-progress--danger { background: var(--btn-danger-bg); }

.r-progress-circle { position: relative; }
.r-progress-circle svg { transform: rotate(-90deg); }
.r-progress-circle__track { fill: none; stroke: var(--btn-secondary-bg); }
.r-progress-circle__bar { fill: none; stroke: var(--color-accent); transition: stroke-dashoffset 0.3s; }
.r-progress-circle__bar.r-progress--success { stroke: var(--color-success); }
.r-progress-circle__bar.r-progress--warning { stroke: var(--color-warning-dark); }
.r-progress-circle__bar.r-progress--danger { stroke: var(--btn-danger-bg); }
