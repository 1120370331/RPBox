...
.achievement-medal {
  ...
  filter: drop-shadow(0 10px 18px var(--achievement-glow));
  transition:
...
.achievement-medal--sm {
  --achievement-size: 44px;
}

.achievement-medal--lg {
  --achievement-size: 86px;
}
...
.achievement-medal__core {
  ...
  box-shadow:
    ...
    inset 0 -6px 14px rgba(77, 48, 28, 0.22);
}

.achievement-medal__core i {
  font-size: calc(var(--achievement-size) * 0.35);
  position: relative;
  z-index: 2;
}
...
.achievement-medal:hover {
  ...
  filter: drop-shadow(0 16px 24px var(--achievement-glow));
}

.achievement-medal:hover .achievement-medal__shine {
  opacity: 0.72;
...
.achievement-medal--locked {
  opacity: 0.48;
  filter: grayscale(0.84) drop-shadow(0 8px 14px rgba(44, 34, 26, 0.12));
}
