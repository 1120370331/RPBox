...
const props = defineProps<{ work: RPDBWork }>()
defineEmits<{ open: [] }>()
    ...
    <div class="work-card__body">
      ...
      <div class="work-card__footer">
        <div class="work-card__author">
          <span class="author-mark">{{ (work.author_name || 'U').charAt(0).toUpperCase() }}</span>
