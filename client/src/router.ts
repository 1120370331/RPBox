  ...
  routes: [
    {
      ...
      children: [
        ...
        { path: 'character-cards/new', name: 'character-card-new', component: () => import('./views/character-cards/CharacterCardNew.vue') },
        { path: 'character-cards/:id/edit', name: 'character-card-edit', component: () => import('./views/character-cards/CharacterCardEditor.vue') },
        { path: 'character-cards/:id', name: 'character-card-detail', component: () => import('./views/character-cards/CharacterCardDetail.vue') },
