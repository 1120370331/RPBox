    ...
    <main class="discovery-main">
      <nav class="content-nav" aria-label="RPDB 内容快捷入口">
        ...
        <div class="content-nav__actions">
          <div class="content-nav__secondary">
          ...
          <router-link class="publish-action" to="/rpdb/create" aria-label="发布 RP 数据库内容">
...
.discovery-main{min-width:0;padding:24px}.content-nav{display:flex;flex-wrap:wrap;align-items:center;justify-content:space-between;gap:16px;margin-bottom:16px;padding:10px;border:1px solid var(--color-border);border-radius:var(--radius-md);background:var(--color-panel-bg);box-shadow:var(--shadow-sm)}.content-nav__channels,.content-nav__actions{display:flex;flex:0 0 auto;align-items:center;gap:6px}.content-nav button,.content-nav a{display:inline-flex;min-height:38px;flex:0 0 auto;align-items:center;gap:7px;padding:0 12px;border:0;border-radius:var(--radius-sm);background:transparent;color:var(--color-text-secondary);font:600 13px/1 inherit;text-decoration:none;white-space:nowrap}.content-nav button{cursor:pointer}.content-nav button:hover,.content-nav a:hover,.content-nav .active{background:var(--btn-secondary-bg);color:var(--btn-secondary-text)}.content-nav i{color:var(--icon-color);font-size:16px}
.content-nav__actions{margin-left:auto}.content-nav__secondary{display:flex;align-items:center;gap:6px}.content-nav a.publish-action{min-height:42px;margin-left:6px;padding:0 18px;border:1px solid color-mix(in srgb,var(--color-accent) 76%,#fff);background:linear-gradient(135deg,color-mix(in srgb,var(--color-accent) 90%,#fff),color-mix(in srgb,var(--color-accent) 72%,#4B3621));color:var(--btn-primary-text);font-weight:800;box-shadow:0 5px 14px color-mix(in srgb,var(--color-accent) 30%,transparent);transition:transform .18s ease,box-shadow .18s ease,filter .18s ease}.content-nav a.publish-action i{color:inherit;font-size:18px}.content-nav a.publish-action:hover{background:linear-gradient(135deg,color-mix(in srgb,var(--color-accent) 96%,#fff),color-mix(in srgb,var(--color-accent) 78%,#4B3621));color:var(--btn-primary-text);filter:saturate(1.08);transform:translateY(-1px);box-shadow:0 8px 18px color-mix(in srgb,var(--color-accent) 38%,transparent)}
...
@media(max-width:1180px){.content-nav{align-items:flex-start;flex-direction:column}.content-nav__actions{width:100%;justify-content:flex-end}.featured-grid__cards{grid-template-columns:1fr 1fr}.featured-grid__cards .featured-card:last-child{display:none}.discovery-main{padding:18px}}
@media(max-width:820px){.content-nav{overflow:hidden}.content-nav__channels{width:100%;overflow-x:auto}.content-nav__actions{width:100%;overflow:visible}.content-nav__secondary{min-width:0;overflow-x:auto}.featured-grid__cards{grid-template-columns:1fr}.featured-card{min-height:260px}.featured-grid__cards .featured-card:nth-child(n+2){display:none}.channel-tabs{overflow:auto}.discovery-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media(max-width:520px){.discovery-main{padding:12px}.content-nav__secondary{display:none}.content-nav a.publish-action{margin-left:auto}.featured-card{min-height:220px}.featured-copy{inset:auto 18px 16px}.featured-copy h2{font-size:21px}.feed-heading{align-items:flex-start}.result-range{display:none}.view-switcher button{padding:0 9px}.view-switcher button span{display:none}.discovery-grid{grid-template-columns:1fr}}
</style>
